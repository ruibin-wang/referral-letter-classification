...
basemodel = XLNetForMultiLabelSequenceClassification(num_labels=len(labels))
...
text_path = 'C:\Ruibin\Code\BERT_text_classification\data\\' + file_name_set[2] + '.csv'
...
bert_optimizer = torch.optim.AdamW(basemodel.parameters(), lr=lr, weight_decay=0.01)
