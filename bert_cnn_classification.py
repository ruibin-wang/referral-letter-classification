...
# train_file = './data/symp_diagnosis_relation_training.csv'
# train_examples = get_train_examples(train_file, labels_5)
# # train_features = get_features_from_examples(train_examples, seq_len, tokenizer, labels_5)
#
# train_features = get_features_from_examples(train_examples, seq_len, tokenizer)
# train_dataset = get_dataset_from_features(train_features)
#
...
for i in range(epochs):
    ...
    for batch in tqdm(train_dataloader):
        ...
        loss, logits = model(bert_output.last_hidden_state, label_ids)
    ...
    for step, batch in enumerate(val_dataloader):
        ...
        with torch.no_grad():
            ...
            logits = model(val_bert_output.last_hidden_state)
