...
def evaluate(bert_model, test_dataloader):
    ...
    with torch.no_grad():
        ...
        for step, batch in enumerate(test_dataloader):
            ...
            test_bert_output = bert_model(test_input_ids, test_input_mask, test_segment_ids)
...
tokenizer = XLMTokenizer.from_pretrained("xlm-mlm-en-2048", truncation=True, do_lower_case=True)


basemodel = RobertaClass()
...
for i in range(epochs):
    ...
    for batch in tqdm(train_dataloader):
        ...
        bert_output = basemodel(input_ids, input_mask, segment_ids)
    ...
    with torch.no_grad():
        ...
        for step, batch in enumerate(val_dataloader):
            ...
            val_bert_output = basemodel(val_input_ids, val_input_mask, val_segment_ids)
