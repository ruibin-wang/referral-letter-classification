...
def generate_dataloader(data_path, batch_size, seq_len, tokenizer, labels):
    ...
    if data_path.split('\\')[-1] is 'no_dot_train.csv':
...
df_train_path = os.path.join(data_path, 'no_dot_train.csv')
df_val_path = os.path.join(data_path, 'no_dot_val.csv')
df_test_path = os.path.join(data_path, 'no_dot_test.csv')
text_path = os.path.join(data_path, 'no_dot_original_text.csv')
