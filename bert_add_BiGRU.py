...
text_path = '.\data\\' + file_name_set[1] + '.csv'
...
# cnn_model = TextRNN(cnn_embed_num, cnn_embed_dim, num_layers, bidirectional, out_dim,
#                              dropout, pretrained_embed=embeddings, use_gru=use_gru, freeze=freeze,
#                              random_embed=random_embed, vocab_size=vocab_size)
